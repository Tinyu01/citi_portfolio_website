    ...
    const experienceData = [
      {
        ...
        company: "Capaciti",
        logo: "assets/CAPCITI-LOGO-V3.jpg",
        tags: ["Software Development", "Agile", "Team Collaboration"],
        situation: "Joined as a software development intern to contribute to various projects and enhance technical skills.",
        task: "Collaborate with the development team to design, develop, and test software applications.",
        action: "Participated in agile sprints, wrote clean and efficient code, and debugged issues to ensure high-quality deliverables.",
        result: "Successfully contributed to the completion of multiple projects, improved coding proficiency, and gained valuable industry experience."
      },
      {
        year: "2024",
        role: "ICT Intern",
        company: "Collins Chabane Local Municipality",
        logo: "assets/Collins_Logo.png",
